...
@author frunziss
*/
public class GuiViewPurchase extends JDialog {

	private JPanel contentPane;
	private static GuiViewPurchase instance=null;
	 ...
	 * Create the frame.
	 */
	public static GuiViewPurchase getInstance()
	{
		if(instance == null) {
	         instance = new GuiViewPurchase();
	      }
	      return instance;
	}
	public GuiViewPurchase() {
		setModal(true);
