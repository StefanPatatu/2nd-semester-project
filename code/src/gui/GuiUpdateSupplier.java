...
@author frunziss
*/
public class GuiUpdateSupplier extends JDialog {
	...
	private static GuiUpdateSupplier instance=null;
	 ...
	 * Create the frame.
	 */
	public static GuiUpdateSupplier getInstance()
	{
		if(instance == null) {
	         instance = new GuiUpdateSupplier();
	      }
	      return instance;
	}
	public GuiUpdateSupplier() {
		...
		btnCancel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				GuiUpdateSupplier.this.dispose();
			}
		});
