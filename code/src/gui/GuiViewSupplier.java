...
public class GuiViewSupplier extends JDialog {

	private JPanel contentPane;
	private static GuiViewSupplier instance=null;
	...
	*/
	 ...
	 * Create the frame.
	 */
	public static GuiViewSupplier getInstance()
	{
		if(instance == null) {
	         instance = new GuiViewSupplier();
	      }
	      return instance;
	}
	public GuiViewSupplier() {
		setModal(true);
